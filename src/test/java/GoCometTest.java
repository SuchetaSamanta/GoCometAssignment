...
public class GoCometTest {
        ...
        public static Boolean TestCase02() throws InterruptedException{
            Boolean status;
            logStatus("Start Testcase", "Test Case 2: Verify User LogIn with an existing username ", "DONE");
            //Register a new User
            Register registration = new Register(driver);
            registration.navigateToRegisterPage();
            status = registration.registerUser("testUser", "abc@123", true);
            logStatus("TestCase 2", "Test Step: User registration", status ? "PASS" : "FAIL");
            //Save the last generated username
            lastGeneratedUserName = registration.lastGeneratedUsername;

            logStatus("TestCase 2", "Test Step: Verify User Login", "DONE");
